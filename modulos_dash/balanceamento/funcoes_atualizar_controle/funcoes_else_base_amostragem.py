...
def correcao_calibre_media_variedade(VARIEDADE,df_comportamento_calibres_TALHAO_PIV):
...
def tratamento_dataset_quality_piv(dataset_quality_piv):
...
def correcao_qualidade_para_variedade(VARIEDADE,dataset_quality_piv):
    if VARIEDADE == 'Tommy Atkins':
        #### QUALIDADE 1
