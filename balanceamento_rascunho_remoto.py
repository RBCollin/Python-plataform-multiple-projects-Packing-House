...
selected = option_menu(
    ...
    options = ['Balanceamento','Previsão e Histórico','Produtividade PH','Etiquetas','Auto Etiqueta','Count Test'],
    icons = ['plus-slash-minus','bar-chart-line-fill','graph-up-arrow','card-heading','gpu-card','camera-video-off-fill'],
    menu_icon = 'box-seam',
    default_index = 0,
...
if selected == 'Previsão e Histórico':
    ...
    ### fazer um select de talhao e outro de ordem controle
    ### e assim trazer o percentual em um grafico
...
if selected == 'Count Test':
    ...
    url_MEGA = 'http://sia:3000/backend/busca_generica/buscaGenerica?view=MGCLI.AGDTI_VW_DX_BALANCEAMENTO_PH'


    dataset_MAF = pd.read_json(url_MAF)
    dataset_MEGA = pd.read_json(url_MEGA)
    ...
    coluna4.video('https://www.youtube.com/watch?v=PNscG92tIrU')
...
####### SE MANDAR MAIS DO QUE DISPONIVEL DO ROLO MANDO O RESTANTE DO ROLO SE N FOR MAIOR QUE 30 
        ...
        ^FO5,137^GFA,241,3936,48,:Z64:eJzt17EJwzAQheEXDLkuWsDYK7hMYcgqGcGlq6DRPIpG0ACGi0bQTwi4uKs/hAsX75fMu6+oXT93bxw8716l+VT3pWZfud/rI4Hn28fkWyXejqEQPxTLxKsa4toS8/vE/DoyP67MT0/mH9TvzKeNebuaR79z8yV8+PDhw4cP/7N/Q3+1/UD9wvz933uP7k+6b+l+pvuc7n/aF7RfaB/R/sJ9N5PePHmfwv79AgsfSKo=:B069
        ^FO23,37^GFA,1709,4180,44,:Z64::9E0B
        ^FO191,16^GFA,289,456,24,:Z64::BCF0
        ^FO17,16^GFA,293,380,20,:Z64::6C8C
        ^FO18,140^GFA,185,304,8,:Z64:eJxjYMAO6hlYGBSAtEMDlHaA0s7nZfRBdIuKkkEDUF2HiqNCA0jdEwcw7a4CoT3gNES+I0UJRNezL5cB0eQCBwcGsDsSoHQAjPZQPafHzj3Bw0PN0JCjh8HFQ0VRYYIHnHYC0fNPMDiC+RxQ2oPB4USKoiFHB9DdSxT12DkECNkPABfJJcA=:48F2
        ^FO287,160^GFA,93,152,8,:Z64:eJxjYMAO5DkgtEIDhHZwgNKcfywUQOIcHC4gvgyHQBOIZu6A0AweCv/A6jwcGqA0WFyhowGsXh6qnxAAAGpnDAw=:A1EC
        ^FO20,59^GFA,93,152,8,:Z64:eJxjYMAO+FuABCMDg4ALhFZQgdAOLDY2NmDayckJTDc5OIBpPihdBJVvYmIC64PQAi5tYPX8LVVgeUIAACo1Cvc=:AE54
        ^FO228,190^GFA,237,440,20,:Z64:eJxjYBgY8LgPRMoAkeIB5j827MwHkMUeAsXq+NsfMDCkn4GKMQDFGspljxcwMJTfqbN4fOAOX/Hcn3eKgWIHgGJld/7LHn/4ByT2r/gHUAyot+7Pc/6+4jns5TIPzxX/qIeKyfP3f57DHg4UY24wB+u1qagHi90Hi7FDxZ7z9jHPYT4H0gu116YCaMfHP8x9Mj/PFUPdZ2FRbvH4wR2gWCVQDOIPegAAB/lajw==:3D29
